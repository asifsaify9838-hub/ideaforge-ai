...
export default async function handler(req, res) {
  try {
    ...
    const prompt = `For the idea: ${idea}, create a short music description (mood, instruments, tempo) and a prompt that can be used with an AI music generator. Return JSON.`;
